  ...
  return (
    ...
    >
      <div className="flex justify-between items-center px-4 py-3">
        {/* Brand Section */}
        <Link to="/" className="flex items-center space-x-2 transition-transform hover:scale-x-110">
        ...
        <div className="hidden md:flex lg:gap-5 font-serif">
          ...
          <div className="relative group lg:mt-2">
            ...
            <div className="absolute top-full left-0 hidden group-hover:block bg-white shadow-lg rounded-lg w-72 mt-2 z-10 animate__animated animate__fadeInDown">
